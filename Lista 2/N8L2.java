...
public class N8L2 {
    ...
    public static void main(String[] args) {
         ...
         * Rombus, cujo símbolo é o R$. Leia um valor com duas casas decimais,
         * equivalente ao salário de uma pessoa de Lisarb. Em seguida, calcule e
        ...
        if(imposto == 0.0){
            ...
            System.out.printf("O valor a ser pago de imposto é de: R$ %.2f%n", imposto);
        }
